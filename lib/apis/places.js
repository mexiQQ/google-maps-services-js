 ...
 */
exports.places = {
  url: 'https://maps.google.cn/maps/api/place/textsearch/json',
  validator: v.object({
...
exports.placesNearby = {
  url: 'https://maps.google.cn/maps/api/place/nearbysearch/json',
  validator: v.object({
 ...
 */
exports.placesRadar = {
  url: 'https://maps.google.cn/maps/api/place/radarsearch/json',
  validator: v.object({
    location: utils.latLng,
    radius: v.number,
    language: v.optional(v.string),
 ...
 */
exports.place = {
  url: 'https://maps.google.cn/maps/api/place/details/json',
  validator: v.object({
    placeid: v.string,
    language: v.optional(v.string),
    retryOptions: v.optional(utils.retryOptions),
 ...
 */
exports.placesPhoto = {
  url: 'https://maps.google.cn/maps/api/place/photo',
  validator: v.object({
...
exports.placesAutoComplete = {
  url: 'https://maps.google.cn/maps/api/place/autocomplete/json',
  validator: v.object({
    input: v.string,
...
exports.placesQueryAutoComplete = {
  url: 'https://maps.google.cn/maps/api/place/queryautocomplete/json',
  validator: v.object({
    input: v.string,
    offset: v.optional(v.number),
    location: v.optional(utils.latLng),
